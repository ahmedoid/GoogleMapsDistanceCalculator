...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    TextView ShowDistanceDuration,ShowDistance;
    Polyline line;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Model_Town = new LatLng(24.774265, 46.738586);
    ...
    private void getDistance(String type) {
        ...
        Call<Example> call = service.getDistanceDuration(origin.latitude + "," + origin.longitude,dest.latitude + "," + dest.longitude, type);
